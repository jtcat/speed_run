...
Com vista em obter a solução em tempo aceitável, criámos três soluções capazes de
o fazer na ordem dos microsegundos. A primeira altera apenas ligeiramente a
solução original, enquanto que a segunda é não recursiva e utiliza o princípio da solução anterior com
algumas optimizações. A terceira combina as duas soluções anteriores.
\subsection{Original}
...
\begin{wrapfigure}[12]{r}{0.47\textwidth}
	\vspace{-13pt}
	\includegraphics[width=\linewidth]{\matlabdir/Results\_sol3/fitted.png}
	\caption{Tempos de execução e função exponencial ajustada.}
	\label{fig:sol3}
\end{wrapfigure}
...
\begin{wrapfigure}[12]{r}{0.47\textwidth}
	\vspace{-13pt}
	\includegraphics[width=\linewidth]{\matlabdir/Results\_sol4/fitted.png}
	\caption{Tempos de execução e função exponencial ajustada.}
	\label{fig:sol4}
\end{wrapfigure}
...
solução Original Improved. Assim, este algoritmo não é mais eficiente do que o Original Improved.
\pagebreak
