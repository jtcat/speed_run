...
trajeto:
\lstinputlisting[firstline=75, lastline=84]{\srcdir/speed\_run.c}
...
\lstinputlisting[firstline=86, lastline=95]{\srcdir/speed\_run.c}
...
\pagebreak
\subsection{Advance and retreat}
\lstinputlisting[firstline=170, lastline=284]{\srcdir/speed\_run.c}
