...
e uma previsão de \num{9.234e+161} segundos para \begin{math}n = 800\end{math}, o que equivale a, aproximadamente, \num{2.969e+154} anos.
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\linewidth]{\matlabdir/Results\_sol2/fitted.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\linewidth]{\matlabdir/Results\_sol4/fitted.png}
	\caption{Tempos de execução e função exponencial ajustada.}
	\label{fig:sol4}
\end{figure}
\pagebreak
