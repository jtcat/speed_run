...
de execução da ordem das centenas de anos para a resolução do caso \begin{math}n = 800\end{math}.
...
a seguinte equação: \begin{math}y = (\num{6.231e-08})\times e^{0.4869}\end{math}.

\begin{figure}[h]
	\includegraphics[width=\linewidth]{\matlabdir/Results/107927\_Original\-and\-fitted.png}
	\caption{Gráfico com os tempos de execução para o número mecanográfico 107927 e a função exponencial ajustada}
	\label{fig:800}
\end{figure}
...
\pagebreak
\begin{figure}[h]
	\includegraphics[width=\linewidth]{\matlabdir/Results/107927\_800.png}
	\caption{Tempo de execução estimado para \begin{math}n = 800\end{math}, utilizando a solução original}
	\label{fig:800}
\end{figure}
\pagebreak
