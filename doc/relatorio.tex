...
O objetivo deste problema é encontrar o menor número de passos necessários para
percorrer a estrada, começando no primeiro segmento e terminando no último, com
velocidade 1.
...
A explicação para a obtenção destes resultados deve-se ao facto de a complexidade computacional
da expressão \foreign{boolean} e da função \verb#valstop# ser a mesma, o que não produz qualquer diferença.
